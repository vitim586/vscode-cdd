...
public:
    ...
    int level; // Alterado para int para armazenar um valor numérico
    std::string race;
    int healthPoints; // Alterado para int para armazenar um valor numérico
    int attackPoints; // Alterado para int para armazenar um valor numérico
